      ...
      <div className="min-h-screen bg-[#0a0a0f] flex flex-col items-center justify-center px-5 animate-fade-in relative overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-8 max-w-sm w-full">
          ...
          <div className="space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl font-serif text-white">How long would you like to chat?</h2>
            <p className="text-gray-400 text-base font-light">Pick a session length. You can always leave early — no pressure.</p>
          </div>
      ...
      <div className="min-h-screen bg-[#0a0a0f] flex flex-col items-center justify-center px-5 animate-fade-in relative overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-8 max-w-sm w-full">
          ...
          <div className="space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl font-serif text-white">How are you feeling?</h2>
            <p className="text-gray-400 text-base font-light">Select all that apply. This helps your listener understand where you are.</p>
          </div>
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white overflow-x-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center px-5 pt-20 pb-16 sm:pt-28 sm:pb-20">
        ...
        <div className="relative z-10 text-center space-y-10 max-w-md w-full">
          <div className="space-y-6">
            <div className="w-20 h-20 rounded-3xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mx-auto shadow-xl shadow-emerald-500/20">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-6xl font-serif text-white leading-[1.1] tracking-tight">
                You don't have to go<br /><span className="bg-gradient-to-r from-emerald-300 via-emerald-400 to-teal-400 bg-clip-text text-transparent">through today alone</span>
              </h1>
          ...
          <div className="space-y-3">
            <button onClick={function() { setRole('seeker'); setStep('mood'); }} className="w-full py-5 px-6 rounded-2xl bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.06] hover:border-emerald-500/30 transition-all text-left group backdrop-blur-sm">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <span className="text-base sm:text-lg font-semibold text-white group-hover:text-emerald-300 transition-colors">I need someone today</span>
                  <p className="text-gray-400 text-sm mt-1 font-light">Be matched with someone who is here to listen</p>
                </div>
            ...
            <button onClick={function() { setRole('listener'); setStep('duration'); }} className="w-full py-5 px-6 rounded-2xl bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.06] hover:border-emerald-500/30 transition-all text-left group backdrop-blur-sm">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <span className="text-base sm:text-lg font-semibold text-white group-hover:text-emerald-300 transition-colors">I can be someone today</span>
                  <p className="text-gray-400 text-sm mt-1 font-light">Be there for someone who needs a quiet presence</p>
                </div>
                <svg className="w-5 h-5 text-gray-600 group-hover:text-emerald-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                </svg>
          ...
          <div className="flex items-center justify-center gap-6">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-sm text-gray-400 font-light">Private</span>
            </div>
            <div className="flex items-center gap-1.5">
              <svg className="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
              </svg>
              <span className="text-sm text-gray-400 font-light">15-30 min</span>
            </div>
            <div className="flex items-center gap-1.5">
              <svg className="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <section className="px-5 py-16 sm:py-24">
        <div className="max-w-3xl mx-auto text-center space-y-12">
          <div className="space-y-3">
            ...
            <p className="text-gray-400 text-base font-light max-w-md mx-auto">Three simple steps. No sign-up, no forms, no barriers.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 space-y-4 hover:border-emerald-500/20 transition-all">
              ...
              <h3 className="text-white font-semibold text-lg">Choose your role</h3>
              <p className="text-gray-400 text-sm font-light leading-relaxed">Need to talk? Or want to listen? Pick what feels right for you today.</p>
            </div>
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 space-y-4 hover:border-emerald-500/20 transition-all">
              <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mx-auto">
                <span className="text-emerald-400 font-serif text-lg">2</span>
              </div>
              <h3 className="text-white font-semibold text-lg">Get matched instantly</h3>
              <p className="text-gray-400 text-sm font-light leading-relaxed">We connect you with a real person in seconds. No profiles, no waiting rooms.</p>
            </div>
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 space-y-4 hover:border-emerald-500/20 transition-all">
              <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mx-auto">
                <span className="text-emerald-400 font-serif text-lg">3</span>
              </div>
              <h3 className="text-white font-semibold text-lg">Talk. That's it.</h3>
              <p className="text-gray-400 text-sm font-light leading-relaxed">Have a real conversation. When the session ends, everything disappears. Nothing is saved.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 py-16 sm:py-24 relative">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-12 relative z-10">
          <div className="space-y-3">
            <h2 className="text-3xl sm:text-5xl font-serif text-white">Built different</h2>
            <p className="text-gray-400 text-base font-light max-w-md mx-auto">We're not a social network. We're not therapy. We're a quiet space between those two things.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 text-left space-y-3 hover:border-emerald-500/20 transition-all">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-white font-semibold text-base">Completely anonymous</h3>
              </div>
              <p className="text-gray-400 text-sm font-light leading-relaxed">No accounts. No names. No traces. Just two humans sharing a moment, then moving on.</p>
            </div>
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 text-left space-y-3 hover:border-emerald-500/20 transition-all">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center flex-shrink-0">
                ...
                <h3 className="text-white font-semibold text-base">Nothing is saved</h3>
              </div>
              <p className="text-gray-400 text-sm font-light leading-relaxed">Conversations exist only in the moment. When you leave, it's gone — like it never happened.</p>
            </div>
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 text-left space-y-3 hover:border-emerald-500/20 transition-all">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center flex-shrink-0">
                ...
                <h3 className="text-white font-semibold text-base">Human-first design</h3>
              </div>
              <p className="text-gray-400 text-sm font-light leading-relaxed">No algorithms deciding who you talk to. No AI pretending to care. Real people, real presence.</p>
            </div>
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 text-left space-y-3 hover:border-emerald-500/20 transition-all">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center flex-shrink-0">
                ...
                <h3 className="text-white font-semibold text-base">Safe space</h3>
              </div>
              <p className="text-gray-400 text-sm font-light leading-relaxed">Community-driven guidelines, abuse reporting, and a culture of kindness built into every interaction.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 py-16 sm:py-24">
        <div className="max-w-3xl mx-auto text-center space-y-12">
          <div className="space-y-3">
            ...
            <p className="text-gray-400 text-base font-light max-w-md mx-auto">We're just getting started. Here's what's coming next.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-5 text-left flex items-start gap-4 hover:border-emerald-500/20 transition-all">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-white font-semibold text-base">Voice sessions</h3>
                ...
                <p className="text-gray-400 text-sm font-light leading-relaxed">Sometimes typing isn't enough. Optional voice chat for deeper connection.</p>
              </div>
            </div>
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-5 text-left flex items-start gap-4 hover:border-emerald-500/20 transition-all">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-white font-semibold text-base">Multi-language</h3>
                ...
                <p className="text-gray-400 text-sm font-light leading-relaxed">Support in multiple languages so more people can find someone who understands.</p>
              </div>
            </div>
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-5 text-left flex items-start gap-4 hover:border-emerald-500/20 transition-all">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-white font-semibold text-base">Listener recognition</h3>
                ...
                <p className="text-gray-400 text-sm font-light leading-relaxed">Anonymous badges and milestones for listeners who show up consistently.</p>
              </div>
            </div>
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-5 text-left flex items-start gap-4 hover:border-emerald-500/20 transition-all">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-white font-semibold text-base">Mobile app</h3>
                ...
                <p className="text-gray-400 text-sm font-light leading-relaxed">A dedicated app so you can be here for someone even when you're on the go.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="px-5 py-16 sm:py-24 relative">
        ...
        <div className="max-w-md mx-auto text-center space-y-8 relative z-10">
          <div className="space-y-4">
            <h2 className="text-3xl sm:text-5xl font-serif text-white">Ready to talk to someone?</h2>
            <p className="text-gray-400 text-base font-light">It takes 10 seconds to connect. No sign-up needed.</p>
          </div>
      ...
      <footer className="px-5 py-12 border-t border-white/[0.06]">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl px-5 py-4 max-w-lg mx-auto">
            <p className="text-gray-400 text-sm font-light leading-relaxed text-center">
          ...
          {/* Copyright */}
          <p className="text-center text-gray-600 text-xs font-light">&copy; 2026 Someone Today. Made with quiet intention.</p>
        </div>
      </footer>
    </div>
  );
